const ExcelService = require('./backend/src/services/ExcelService_v3');
const fs = require('fs');

console.log('🧪 Тестирование ExcelService_v3 (гибкий парсер)...');
...
excelService.processExcelFile(buffer)
  .then(result => {
    ...
    console.log('\n📝 Последние 5 логов:');
    const logs = excelService.debugLogs.slice(-5);
    logs.forEach(log => {
