    ...
    <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg">
              <div className="flex items-center">
                ...
                <span className="font-medium text-gray-900">Оптимальная нагрузка</span>
              </div>
              <div className="text-right">
                <p className="text-sm text-gray-600">
                  {enhancedAnalytics.routeStats?.totalRoutes - 
                   (enhancedAnalytics.efficiencyAnalysis?.overloadedRoutes?.length || 0) - 
                   (enhancedAnalytics.efficiencyAnalysis?.underloadedRoutes?.length || 0)} маршрутов
                </p>
                <p className="text-lg font-bold text-green-600">
                  {((enhancedAnalytics.routeStats?.totalRoutes - 
                    (enhancedAnalytics.efficiencyAnalysis?.overloadedRoutes?.length || 0) - 
                    (enhancedAnalytics.efficiencyAnalysis?.underloadedRoutes?.length || 0)) / 
                    enhancedAnalytics.routeStats?.totalRoutes * 100).toFixed(0)}%
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-4 bg-red-50 rounded-lg">
              <div className="flex items-center">
                ...
                <span className="font-medium text-gray-900">Перегруженные</span>
              </div>
              <div className="text-right">
                <p className="text-sm text-gray-600">
                  {enhancedAnalytics.efficiencyAnalysis?.overloadedRoutes?.length || 0} маршрутов
                </p>
            ...
            <div className="flex items-center justify-between p-4 bg-yellow-50 rounded-lg">
              <div className="flex items-center">
                ...
                <span className="font-medium text-gray-900">Недогруженные</span>
              </div>
              <div className="text-right">
                <p className="text-sm text-gray-600">
                  {enhancedAnalytics.efficiencyAnalysis?.underloadedRoutes?.length || 0} маршрутов
          ...
          <div className="space-y-4">
            <div className="p-4 bg-blue-50 rounded-lg">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-900">Прогноз заказов</p>
                  <p className="text-xs text-gray-600">На следующую неделю</p>
                </div>
                <div className="text-right">
                  <p className="text-lg font-bold text-blue-600">
                    {enhancedAnalytics.predictions?.nextWeekOrders || 0}
                  </p>
            ...
            <div className="p-4 bg-green-50 rounded-lg">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-900">Прогноз выручки</p>
                  <p className="text-xs text-gray-600">На следующую неделю</p>
                </div>
                <div className="text-right">
                  <p className="text-lg font-bold text-green-600">
                    {(enhancedAnalytics.predictions?.nextWeekRevenue || 0).toFixed(0)} грн
                  </p>
            ...
            <div className="p-4 bg-purple-50 rounded-lg">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-gray-900">Оптимальное количество</p>
                  <p className="text-xs text-gray-600">Курьеров</p>
                </div>
                <div className="text-right">
                  <p className="text-lg font-bold text-purple-600">
                    {enhancedAnalytics.predictions?.optimalCourierCount || 0}
                  </p>
                  <p className="text-xs text-gray-600">курьеров</p>
                </div>
              </div>
      ...
      <div className={clsx(
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {enhancedAnalytics.efficiencyAnalysis?.improvementSuggestions?.map((suggestion: string, index: number) => (
          ...
          {enhancedAnalytics.loadBalancing?.recommendations?.map((recommendation: string, index: number) => (
            <div key={index} className="flex items-start space-x-3 p-4 bg-green-50 rounded-lg">
              <BoltIcon className="h-5 w-5 text-green-600 mt-0.5" />
