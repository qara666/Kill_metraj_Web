  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={clsx(
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-gradient-to-br from-slate-900 via-blue-900 to-pink-300 shadow-2xl">
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-64 lg:flex-col">
        <div className="flex flex-col flex-grow bg-gradient-to-br from-slate-900 via-blue-900 to-pink-300 shadow-2xl">
      ...
      <div className="lg:pl-64">
        {/* Top bar */}
        <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-gradient-to-r from-white via-blue-50 to-pink-50 px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
          <button
            type="button"
