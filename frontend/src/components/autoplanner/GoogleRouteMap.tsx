...
export const GoogleRouteMap: React.FC<GoogleRouteMapProps> = React.memo(({ route, onMarkerClick }) => {
    ...
    useEffect(() => {
        ...
        const initMap = async () => {
            try {
                ...
                console.error('Ошибка инициализации карты Google:', error);
            }
        };
    ...
    return (
        <div className="mt-4" onClick={(e) => e.stopPropagation()}>
            <div className={clsx('text-xs font-medium mb-2', isDark ? 'text-gray-200' : 'text-gray-700')}>
                Визуализация маршрута (Google Maps):
            </div>
            <div
                ref={mapRef}
